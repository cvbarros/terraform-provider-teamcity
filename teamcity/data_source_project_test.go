		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resName, "url", "http://localhost:8112/project.html?projectId=_Root"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			...
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resName, "url", "http://localhost:8112/project.html?projectId=TestProject"),
				),
			},
		},
	})
