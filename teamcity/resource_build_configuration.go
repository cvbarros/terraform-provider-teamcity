...
func resourceBuildConfigurationCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if config != nil {
		bt.Parameters = bt.Parameters.Concat(config)
	}
	if system != nil {
		bt.Parameters = bt.Parameters.Concat(system)
	}
	if env != nil {
		bt.Parameters = bt.Parameters.Concat(env)
	}
...
func resourceBuildConfigurationRead(d *schema.ResourceData, meta interface{}) error {
	...
	var configParams, sysParams, envParams = flattenParameters(dt.Parameters)
